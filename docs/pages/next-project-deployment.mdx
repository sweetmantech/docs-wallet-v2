...
🔗  Linked to your-projects/my-wallet-app (created .vercel)
🔍  Inspect: https://vercel.com/your-projects/my-wallet-app/2Y8XQ5M5tgasjBMK4AbU5eUTvnm4 [3s]
✅  Production: https://my-wallet-app-your-projects.vercel.app [3s]```
````
...
✅ Added Environment Variable CDP_API_KEY_ID to Project [299ms]
vercel env add
Vercel CLI x.x.x
...
multiple)? Production, Preview, Development
✅ Added Environment Variable CDP_API_KEY_SECRET to Project delete-wallet-v2-app [377ms]
vercel env add
Vercel CLI x.x.x
...
multiple)? Production, Preview, Development
✅ Added Environment Variable CDP_WALLET_SECRET to Project delete-wallet-v2-app [336ms]
vercel env add
Vercel CLI x.x.x
...
multiple)? Production, Preview, Development
✅ Added Environment Variable CDP_PAYMASTER_URL to Project delete-wallet-v2-app [425ms]
